...
Mareo V0 packages the following primary third-party runtimes:
...
- Electron 44.2.0, licensed under the MIT License. Electron and Chromium license notices are preserved in the packaged application.

Licenses shipped by the remaining npm dependencies are preserved with their packages in the locked DSH runtime dependency tree.
